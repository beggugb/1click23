...
import ClienteIndex from './BundleCrm/clientes/views/ClienteIndex'
import ClienteEdit from './BundleCrm/clientes/views/ClienteEdit'
import Categorias from './BundleCrm/categorias/views/CategoriaIndex'
      ...
      <div>
        ...
        <div className="h-full w-full flex-1 p-1">            
            <Routes>                  
                  ...
                  <Route path="/clientes/new" element={<ClienteEdit />}/>
