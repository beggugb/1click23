...
import { categoriasData, categoriasCreate, categoriasDelete, categoriasUpdate  } from '@reducers/crm/categoriaSlice'
import Loading from '@components/snippets/Loading'
import Table from '@components/tables/TableEditItemx'
  ...
  <>
    <div className="h-auto w-full flex-col">     
        <div className="h-430 mt-1 flex w-full">                     
              ...
              <div className='w-3/4 flex-col ml-1 mr-1 mt-1'>                
                <Table                                
                indicador={indicador}      
                data={data}
                item={nitem}
