...
import { EyeIcon, EyeSlashIcon, HandThumbUpIcon } from "@heroicons/react/24/outline";
import { _validateConfig, _itemCliente  } from '@data/models'
import {  _paises, _tipoCliente, getCiudades } from '@data/dataLoad'
import { clientesUpdate, clientesCreate  } from '@reducers/crm/clienteSlice'
...
const ClienteEdit = () => {
  ...
  return (
    ...
    <div className="h-full w-full flex-col"> 
        <div className="h-5 flex w-full flex-row items-center border-b">
                <div className="h-5 flex bg-gray-400 border border-gray-300 rounded-t-md mr-1">   
                    <button 
                    onClick={() =>navigate("/admin/adm/clientes")}
        ...
        <div className='h-510 flex-col w-full'>
            <div className='h-7 pl-1 border-b w-full flex items-end text-[10px]'>
                <button onClick={() => settab('1')} className={tab === '1'? "h-5 w-36 bg-sky-300  text-white border border-sky-300 flex items-center justify-center rounded-t":"h-5 w-36  bg-gray-200 rounded-t text-gray-500 border-l border-gray-300 flex items-center justify-center"}>
                    General
                </button>
                <button onClick={() => settab('2')} className={tab === '2'? "h-5 w-36 bg-sky-300  text-white border border-sky-300 flex items-center justify-center rounded-t":"h-5 w-36  bg-gray-200 rounded-t text-gray-500 border-r border-gray-300 flex items-center justify-center"}>
                    Ubicación
                </button>  
            ...
            <div className={tab === '1' ? "visible h-480 flex p-1":"hidden"}> 
                                <div className="w-1/3 border flex-col">
                                    ...
                                    <div className='h-8 m-4 flex-col justify-center items-center p-2 text-[12px] text-gray-50'>
                                        <div className='h-8 w-full flex shadow justify-center items-center rounded border'>
                                            <Switch                         
                                                onChange={ changesAA }  
                                        ...
                                        <p className='text-center text-gray-500 font-bold italic' >Habilitado</p>
                                    </div> 
                                </div>
                                ...
                                <div className="w-2/3 border flex-col ml-1">
                                    ...
                                    <form onSubmit={handleSubmit} className="rounded p-2 flex-col text-[10px] ">    
                                            ...
                                            <div className='w-full flex rounded-md pt-1'>
                                                ...
                                                <div className="w-4/6 flex-col ml-1">
                                                ...
                                                <div className="w-1/6 flex-col ml-1">
                                                <label htmlFor="vencimiento" className="p-1 font-bold  text-gray-500">Vencimiento</label>
                                                    <input
                                                        type="date"
                                                        onChange={(e)=>handleChange(e.target.name,e.target.value)}                                                                    
                                                        value={nitem.vencimiento}
                                                        name="vencimiento"
                                                        className="h-7 pl-2 block w-full text-[10px] border text-gray-600 border-gray-300 rounded focus:bg-gray-50 focus:border-gray-100"/>                                                           
                                                </div>    
                                            </div>
                                            ...
                                            <div className='w-full flex rounded-md pt-1'>
                                                <div className="w-full flex-col">
                                                    <button
                                                        type="submit"
                                                        className={errors.nombres === "" && errors.apellidos === "" && errors.direccion === "" && errors.telefono === "" && errors.nit === "" && errors.email === "" ? 'h-7 w-20 border bg-orange-400  hover:bg-orange-300 rounded-md':'h-7 w-20 border bg-orange-300 cursor-not-allowed hover:bg-orange-300 rounded-md'}>                                    
                            ...
                            <div className={tab === '2' ? "visible flex-col p-1 h-480":"hidden"}>                                
                                <div className='h-430 border w-full flex'>
                                ...
                                <div className='h-10 border-b w-full flex mt-2 text-[10px] items-center'>
                                    <button 
                                    type="button"
