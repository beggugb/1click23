import { CheckIcon, CurrencyDollarIcon, PlusIcon, PencilIcon, DocumentTextIcon, TrashIcon } from "@heroicons/react/24/outline";

const MenuAprobacion = ({indicador,handleNew, handleEdit,handleDetail, handleShow,handleTrash,handlePay,estado,types}) => {      
    return (       
        <div className="w-full justify-start items-center flex">     
            <div className="w-full justify-start items-center flex">
                { types === "comprobante" ?
                    <div className="w-40     flex justify-between flex-row pl-1">
                    <button 
                    ...
                    <button 
                        className={indicador > 0 && estado === 'pendiente' ? "h-7 w-8 items-center bg-sky-400 text-white justify-center border-r flex": "h-7 w-8 items-center bg-gray-300 border-r text-gray-100 justify-center flex cursor-not-allowed"} 
