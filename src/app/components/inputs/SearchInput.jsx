...
const SearchInput = ({handleSearch, name, items,parametro,setparametro,setparametroId,compuesto}) => {
    ...
    const handleAsignar = (ite) =>{
        switch (name) {
            case "Producto":
                setparametro(ite.nombre)
                setparametroId(ite.id)    
                break;
            case "Proveedor":
                compuesto(ite)    
                break;
                            ...
                            <table className="border-collapse w-full">
                                <tbody>
                                    ...
                                    onClick={() => handleAsignar(ite)}>                                                                            
                                        <td className="h-6 border-b border-gray-300 text-[10px] text-gray-700 hover:bg-gray-200">{ite.nombre || ite.labels || ite.label || ite.razonSocial}</td>                                        
                                    </tr>
                                    ))}                                
                                </tbody>
                            </table>
