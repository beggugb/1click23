...
const SearchPuc = ({handleSearch, name, items,parametro,setparametro,setparametroId,compuesto}) => {
                            ...
                            <table className="border-collapse w-full">
                                <tbody>
                                    ...
                                    onClick={() => handleAsignar(ite)}>                                                                            
                                        <td className="h-6 border-b border-gray-300 text-[10px] text-gray-700 hover:bg-gray-200">{ite.codigo} - {ite.descripcion} - ("{ite.tipo}")</td>                                        
                                    </tr>
                                    ))}                                
                                </tbody>
                            </table>
