...
import { CloudArrowDownIcon, XCircleIcon, MagnifyingGlassIcon } from "@heroicons/react/24/outline";
const fHoy = "_"+getFechas()



const Searchs = ({parametro,setParametro,handleSearch, handleParametro,data,name }) => {   
    const hReset = () =>{
      setParametro("")
      handleParametro()      
    }
  ...
  return (    
    <div className="h-8 bg-gray-100 flex text-[10px] w-full items-center">          
