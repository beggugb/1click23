...
import {  _pag, getCiudades } from '@data/dataLoad'
import Select from '@components/selects/Select'
import SelectUnit from '@components/selects/SelectUnit'

const ciudades = getCiudades(1)


const TableEdit = ({type,indicador, data, item, pagina,paginas,total,handleChange, handleEditar, handleSave, handleTrash, handleReset, handleData}) => {
            ...
            <table className="border-collapse w-full text-[10px] ">
                <thead>
                    <tr className="h-7 bg-gray-100 border-l border-r">
                        ...
                        <th className="w-4/12 text-stone-600 border-r">
                        ...
                        <th className="w-3/12 text-stone-600 border-r">
                          <div className='w-full flex'>
                            <div
                              className='w-5/6 flex items-center justify-center'>
                              <span>Dirección</span>
                            ...
                            <button
                            onClick={() => handleSubData("encargado")}
                            className='w-1/6 flex justify-center'>
                              <ChevronUpDownIcon className="h-5 w-5 text-gray-500" />
                            </button>
                          </div>
