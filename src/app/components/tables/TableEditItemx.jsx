...
const TableEditItemx = ({indicador, data, item, pagina,paginas,total,handleChange, handleEditar, handleSave, handleTrash, handleReset, handleData,changeAA}) => {
